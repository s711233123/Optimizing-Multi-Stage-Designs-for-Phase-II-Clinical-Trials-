...
cliRequirement <- list(
  p0 = 0.75,    # response rate in the null hypothesis
  p1 = 0.95,    # response rate in the alternative hypothesis
  alpha = 0.05, # upper bound of type I error
  beta = 0.2   # upper bound of type II error
)
